...
#ifndef HW2_PROB1B_MY_HEADER_FILE_H
#define HW2_PROB1B_MY_HEADER_FILE_H

#endif //HW2_PROB1B_MY_HEADER_FILE_H
...
void delete_2Darray(unsigned char** array, int width, int height);
