EE569 Homework Assignment Prob2c
Date: March 4, 2018
Name : Akshata Bhat
USC ID : 9560895350
...
2. Run this command in the project folder:
    g++ -o hw2_prob2c.exe hw2_prob2c.cpp
3. You should see the program executable named : hw2_prob2c.exe

4.The executable should be run with these arguments:
program_name = ./hw2_prob2c.exe 

hw2_prob2c <input_image.raw> <width> <height> <bytes_per_pixel>
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
Example : ./hw2_prob2c.exe flower.raw 700 700 3
