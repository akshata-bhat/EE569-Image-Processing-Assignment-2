...
#ifndef HW2_PROB2C_MY_HEADER_FILE_H
#define HW2_PROB2C_MY_HEADER_FILE_H

#endif //HW2_PROB2C_MY_HEADER_FILE_H
...
int position_of_minimum_value(double* array, int length)
{
    int position = 0;
